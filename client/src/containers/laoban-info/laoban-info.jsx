...
class LaobanInfo extends Component {
  ...
  uploaddata = () =>{
    const {degree,skill,companyname,salary,avatar}=this.state
    this.props.updateUser({degree,skill,companyname,salary,avatar})
  }
  setAvatar=(avatar)=>{
      ...
      <div>
        ...
        <WingBlank>
          <List>
            ...
            >
              <List.Item arrow="down">学历要求</List.Item>
            </Picker>
            <WhiteSpace />
